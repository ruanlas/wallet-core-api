...
func TestGetByIdSuccess(t *testing.T) {
	...
	invoiceProject, err := _readingProcess.GetById(searchCtx)
	assert.NoError(t, err)
	assert.Equal(t, "cd1cc27b-28a1-47dc-ac76-70e8185e159d", invoiceProject.Id)
}
