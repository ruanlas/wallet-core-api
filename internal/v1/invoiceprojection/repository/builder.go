...
type InvoiceProjectionBuilder struct {
	id            string
	createdAt     time.Time
	buyAt         time.Time
	payIn         time.Time
...
func NewInvoiceProjectionBuilder() *InvoiceProjectionBuilder {
	return &InvoiceProjectionBuilder{}
}
func (builder *InvoiceProjectionBuilder) AddId(id string) *InvoiceProjectionBuilder {
	builder.id = id
	return builder
}
func (builder *InvoiceProjectionBuilder) AddCreatedAt(createdAt time.Time) *InvoiceProjectionBuilder {
	builder.createdAt = createdAt
	return builder
}
func (builder *InvoiceProjectionBuilder) AddPayIn(payIn time.Time) *InvoiceProjectionBuilder {
	builder.payIn = payIn
	return builder
}
func (builder *InvoiceProjectionBuilder) AddBuyAt(buyAt time.Time) *InvoiceProjectionBuilder {
	builder.buyAt = buyAt
	return builder
}
func (builder *InvoiceProjectionBuilder) AddDescription(description string) *InvoiceProjectionBuilder {
	builder.description = description
	return builder
}
func (builder *InvoiceProjectionBuilder) AddValue(value float64) *InvoiceProjectionBuilder {
	builder.value = value
	return builder
}
func (builder *InvoiceProjectionBuilder) AddPaymentType(paymentType PaymentType) *InvoiceProjectionBuilder {
	builder.paymentType = paymentType
	return builder
}
func (builder *InvoiceProjectionBuilder) AddIsAlreadyDone(isAlreadyDone bool) *InvoiceProjectionBuilder {
	builder.isAlreadyDone = isAlreadyDone
	return builder
}
func (builder *InvoiceProjectionBuilder) AddUserId(userId string) *InvoiceProjectionBuilder {
	builder.userId = userId
	return builder
}
func (builder *InvoiceProjectionBuilder) AddCategory(category InvoiceCategory) *InvoiceProjectionBuilder {
	builder.category = category
	return builder
}
func (builder *InvoiceProjectionBuilder) Build() *InvoiceProjection {
	invoiceProjection := InvoiceProjection{}

	invoiceProjection.Id = builder.id
	invoiceProjection.CreatedAt = builder.createdAt
	invoiceProjection.PayIn = builder.payIn
	invoiceProjection.BuyAt = builder.buyAt
	invoiceProjection.Description = builder.description
	invoiceProjection.Value = builder.value
	invoiceProjection.PaymentType = builder.paymentType
	invoiceProjection.IsAlreadyDone = builder.isAlreadyDone
	invoiceProjection.UserId = builder.userId
	invoiceProjection.Category = builder.category
